...
class WebsiteController {
  ...
  static async getByName(req, res) {
    try {
      ...
      // Handle different website types with their specific data formats
        ...
        case 'ecommerce':
          try {
            ...
            if (ecommerce) {
              ...
              // Return response in ecommerce.json format
              return res.status(200).json({
                vendor: {
                  id: ecommerce.slug,
                  slug: ecommerce.slug,
        ...
        case 'automobiles':
          try {
            ...
            if (automobile) {
              ...
              // Return response in automobiles.json format
              return res.status(200).json({
                success: true,
                timestamp: new Date().toISOString(),
                data: {
        ...
        case 'weddings':
          try {
            ...
            if (wedding) {
              ...
              // Return response in wedding.json format
              return res.status(200).json({
                status: 'success',
                statusCode: 200,
        ...
        case 'professional':
          try {
            ...
            if (business) {
              ...
              // Return response in business.json format
              return res.status(200).json({
                status: 'success',
                statusCode: 200,
