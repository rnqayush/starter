...
const WebsiteResponseService = require('../services/websiteResponseService');
...
class WebsiteController {
  ...
  // Get website by name - Simplified using WebsiteResponseService
  static async getByName(req, res) {
    try {
      const { websiteName } = req.params;

      // Use the unified service to get website data in correct format
      const responseData = await WebsiteResponseService.getWebsiteBySlug(websiteName);
