...
export const businessWebsiteData = {
  salon: {
    ...
    hero: {
      ...
      backgroundImage: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?ixlib=rb-4.0.3&w=1200&q=80'
    },
    about: {
    ...
    services: [
      {
        ...
        icon: '✂️',
        title: 'Hair Styling',
        description: 'Professional cuts, colors, and treatments for all hair types',
        price: 'From $45'
      },
      {
        id: 2,
    ...
    gallery: [
      ...
      { id: 4, category: 'Salon Interior', images: 4, description: 'Our beautiful space' }
    ],
    packages: [
      {
        id: 1,
      ...
      },
      {
        id: 2,
        name: 'Spa Day',
        description: 'Full day relaxation with massage, facial, and beauty treatments',
        price: '$199',
        duration: '6 hours',
        featured: false
      },
    ...
    testimonials: [
      {
        ...
        role: 'Manager',
        review: 'Amazing service! The team is professional and the results are outstanding.',
        rating: 5,
        image: ''
      },
      {
        ...
        role: 'CEO',
        review: 'Highly recommend! Great experience and excellent customer service.',
        rating: 5,
        image: ''
      },
      {
        ...
        role: 'Designer',
        review: 'Love coming here! The atmosphere is relaxing and staff is wonderful.',
        rating: 5,
        image: ''
      }
    ],
    ...
    faq: [
      {
        ...
        answer: 'We are open Monday through Saturday from 9 AM to 6 PM, and Sunday from 10 AM to 4 PM.'
      },
      {
        id: 2,
        question: 'Do you accept walk-ins?',
        answer: 'We accept walk-ins based on availability, but appointments are recommended for guaranteed service.'
      },
      {
        id: 3,
      ...
      },
      {
        ...
        answer: 'Yes! We offer special group packages for bridal parties, birthdays, and other celebrations.'
      },
      {
        id: 5,
        question: 'What products do you use?',
        answer: 'We use premium professional brands including Redken, OPI, Dermalogica, and other high-quality products.'
      }
    ],
    businessHours: {
      title: 'Business Hours',
    ...
    contact: {
      title: 'Get In Touch',
      description: 'Ready to book your appointment? Contact us today and let us help you look and feel your best.',
    ...
    footer: {
      title: 'Beauty Salon',
      description: 'Transform your look with our expert stylists and premium beauty treatments.',
  ...
  gym: {
    ...
    hero: {
      ...
      backgroundImage: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?ixlib=rb-4.0.3&w=1200&q=80'
    },
    about: {
      title: 'About Our Gym',
    ...
    gallery: [
      { id: 1, category: 'Gym Equipment', images: 12, description: 'State-of-the-art equipment' },
      { id: 2, category: 'Group Classes', images: 8, description: 'Dynamic fitness classes' },
      { id: 3, category: 'Swimming Pool', images: 5, description: 'Olympic-size pool facility' },
      { id: 4, category: 'Facilities', images: 6, description: 'Modern gym facilities' }
    ],
    packages: [
      {
        id: 1,
    ...
    testimonials: [
      {
        ...
        company: 'Tech Corp',
        role: 'Manager',
        review: 'Amazing gym with excellent trainers. Lost 20 pounds in 3 months!',
        rating: 5,
        image: ''
      },
      {
        ...
        role: 'Nurse',
        review: 'The yoga classes are fantastic and the facility is always clean.',
        rating: 5,
        image: ''
      },
      {
    ...
    faq: [
      {
        ...
        answer: 'We are open Monday through Friday 5 AM to 11 PM, Saturday 6 AM to 10 PM, and Sunday 7 AM to 9 PM.'
      },
      {
        id: 2,
        question: 'Do you offer trial memberships?',
        answer: 'Yes! We offer a 7-day free trial for new members to experience all our facilities and classes.'
      },
      {
        id: 3,
        question: 'Are personal trainers included?',
        answer: 'Personal training sessions are available for an additional fee. All our trainers are certified professionals.'
      },
      {
        id: 4,
        question: 'What should I bring for my first visit?',
        answer: 'Bring comfortable workout clothes, athletic shoes, a water bottle, and a towel. We provide lockers and basic amenities.'
      },
      {
        id: 5,
        question: 'Do you have parking available?',
        answer: 'Yes, we have free parking available for all members and visitors.'
      }
    ],
    businessHours: {
      title: 'Gym Hours',
    ...
    contact: {
      ...
      description: 'Ready to begin your fitness journey? Contact us to schedule a tour and start your free trial.',
    ...
    footer: {
      title: 'Elite Fitness Center',
      description: 'Your partner in achieving fitness goals and living a healthier lifestyle.',
  ...
  restaurant: {
    ...
    hero: {
      ...
      backgroundImage: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-4.0.3&w=1200&q=80'
    },
    about: {
      title: 'Our Story',
    ...
    gallery: [
      { id: 1, category: 'Signature Dishes', images: 15, description: 'Our most popular menu items' },
      { id: 2, category: 'Restaurant Interior', images: 8, description: 'Elegant dining atmosphere' },
      { id: 3, category: 'Wine Collection', images: 6, description: 'Premium wine selection' },
      { id: 4, category: 'Kitchen', images: 4, description: 'Our culinary workspace' }
    ],
    packages: [
      {
        id: 1,
    ...
    testimonials: [
      {
        ...
        company: 'Food Critic',
        role: 'Reviewer',
        review: 'Exceptional authentic Italian cuisine. The pasta is made fresh daily and the wine selection is outstanding.',
        rating: 5,
        image: ''
      },
      {
        ...
        company: 'Travel Blog',
        role: 'Food Blogger',
        review: 'Feels like dining in Italy! The atmosphere and food transport you to the heart of Tuscany.',
        rating: 5,
        image: ''
      },
      {
        ...
        role: 'Editor',
        review: 'Perfect for business dinners and special occasions. Impeccable service and incredible food.',
        rating: 5,
        image: ''
      }
    ],
    reviews: [
      {
        ...
        date: '2023-12-20',
        rating: 5,
        review: 'Best Italian restaurant in the city! The tiramisu is to die for.',
        avatar: ''
      },
      {
        id: 2,
      ...
      },
      {
        ...
        date: '2023-12-15',
        rating: 4,
        review: 'Wonderful atmosphere and delicious food. Will definitely return.',
        avatar: ''
      }
    ],
    faq: [
      {
        ...
        answer: 'Yes, we highly recommend making reservations, especially for dinner service and weekends. You can book online or call us directly.'
      },
      {
        id: 2,
        question: 'Do you accommodate dietary restrictions?',
        answer: 'Absolutely! We offer vegetarian, vegan, and gluten-free options. Please inform us of any allergies when making your reservation.'
      },
      {
        id: 3,
        question: 'Is there parking available?',
        answer: 'We offer complimentary valet parking in the evenings and have a public parking structure nearby.'
      },
      {
        id: 4,
        question: 'Do you cater events?',
        answer: 'Yes, we provide catering services for private events, corporate meetings, and special occasions. Contact us for custom menus.'
      },
      {
        id: 5,
        question: 'What is your dress code?',
        answer: 'We maintain a smart casual dress code. No shorts, flip-flops, or athletic wear during dinner service.'
      }
    ],
    businessHours: {
    ...
    contact: {
      ...
      description: 'Experience authentic Italian dining at its finest. Reserve your table today for an unforgettable culinary journey.',
    ...
    footer: {
      title: 'Bella Vista Restaurant',
      description: 'Bringing authentic Italian flavors to your table with traditional recipes and modern elegance.',
  ...
  freelancer: {
    ...
    services: [
      ...
      },
      {
        ...
        description: 'Print and digital graphics for marketing and business materials',
        price: 'From $300'
      },
      {
        id: 6,
        ...
        description: 'Animated graphics and video content for digital marketing',
        price: 'From $600'
      }
    ],
    experience: [
    ...
    packages: [
      {
        ...
        price: '$1,499',
        duration: '2-3 weeks',
        includes: ['Custom Web Design', 'Responsive Layout', 'Basic SEO', 'Contact Forms'],
        featured: false
      },
      {
        id: 2,
        ...
        price: '$2,999',
        duration: '4-6 weeks',
        includes: ['Custom Design & Development', 'CMS Integration', 'Advanced SEO', 'Analytics Setup', 'Social Media Integration'],
        featured: true
      },
      {
        id: 3,
        ...
        price: '$4,999',
        duration: '6-8 weeks',
        includes: ['Complete Brand Identity', 'Custom Web Application', 'E-commerce Integration', 'Performance Optimization', 'Ongoing Support'],
        featured: false
      }
    ],
    reviews: [
    ...
    faq: [
      {
        ...
        answer: 'Project timelines vary based on scope, typically 1-6 weeks for most projects. I provide detailed timelines during our initial consultation.'
      },
      {
        id: 2,
        question: 'Do you provide ongoing support?',
        answer: 'Yes, I offer ongoing support and maintenance packages for all projects. This includes updates, bug fixes, and content changes.'
      },
      {
        id: 3,
        question: 'What are your payment terms?',
        answer: 'I typically require 50% upfront and 50% upon completion. For larger projects, we can arrange milestone-based payments.'
      },
      {
        id: 4,
        question: 'Do you work with international clients?',
        answer: 'Absolutely! I work with clients worldwide and am experienced in remote collaboration using various communication tools.'
      },
      {
        id: 5,
        question: 'What do you need to get started?',
        answer: 'I need a clear brief of your project goals, target audience, preferred style, any existing brand materials, and content/images you want to include.'
      }
    ],
    businessHours: {
      title: 'Availability',
    ...
    footer: {
      ...
      description: 'Transforming ideas into stunning digital experiences through creative design and development.',
...
export const updateBusinessWebsiteData = (slug, updatedData) => {
  if (businessWebsiteData[slug]) {
    businessWebsiteData[slug] = { ...businessWebsiteData[slug], ...updatedData };
