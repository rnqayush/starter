...
export const BUSINESS_ENDPOINTS = {
  ...
  SECTION: (slug, section) => `${BASE_PATH}/business/${slug}/sections/${section}`,
...
export const ECOMMERCE_ENDPOINTS = {
  ...
  PRODUCT: (slug, productId) => `${BASE_PATH}/stores/${slug}/products/${productId}`,
  CATEGORIES: (slug) => `${BASE_PATH}/stores/${slug}/categories`,
  CATEGORY: (slug, categoryId) => `${BASE_PATH}/stores/${slug}/categories/${categoryId}`,
  ORDERS: (slug) => `${BASE_PATH}/stores/${slug}/orders`,
  ORDER: (slug, orderId) => `${BASE_PATH}/stores/${slug}/orders/${orderId}`,
  ORDER_STATUS: (slug, orderId) => `${BASE_PATH}/stores/${slug}/orders/${orderId}/status`,
  ENQUIRIES: (slug) => `${BASE_PATH}/stores/${slug}/enquiries`,
  ENQUIRY_RESPOND: (slug, enquiryId) => `${BASE_PATH}/stores/${slug}/enquiries/${enquiryId}/respond`,
  ANALYTICS: (slug) => `${BASE_PATH}/stores/${slug}/analytics`,
  WISHLIST: (slug) => `${BASE_PATH}/stores/${slug}/wishlist`,
  WISHLIST_ITEM: (slug, productId) => `${BASE_PATH}/stores/${slug}/wishlist/${productId}`,
  ...
  SECTION: (slug, sectionId) => `${BASE_PATH}/stores/${slug}/sections/${sectionId}`,
};
...
export const WEDDING_ENDPOINTS = {
  ...
  VENDOR_BOOKINGS: (vendorId) => `${BASE_PATH}/wedding/vendors/${vendorId}/bookings`,
