...
export const fetchBusinessData =
  businessService.fetchBusinessData.bind(businessService);
export const updateBusinessData =
  businessService.updateBusinessData.bind(businessService);
export const fetchBusinessSection =
  businessService.fetchBusinessSection.bind(businessService);
export const updateBusinessSection =
  businessService.updateBusinessSection.bind(businessService);
export const fetchMultipleBusinessData =
  businessService.fetchMultipleBusinessData.bind(businessService);
export const validateBusinessData =
  businessService.validateBusinessData.bind(businessService);
export const checkAPIStatus =
  businessService.checkAPIStatus.bind(businessService);
export const detectBusinessType =
  businessService.detectBusinessType.bind(businessService);
export const getBusinessTypeConfig =
  businessService.getBusinessTypeConfig.bind(businessService);
...
export const fetchHotelSections =
  hotelService.fetchHotelSections.bind(hotelService);
export const fetchOwnerHotels =
  hotelService.fetchOwnerHotels.bind(hotelService);
...
export const fetchHotelReviews =
  hotelService.fetchHotelReviews.bind(hotelService);
export const searchHotels = hotelService.searchHotels.bind(hotelService);
export const fetchAmenitiesList =
  hotelService.fetchAmenitiesList.bind(hotelService);
export const fetchHotelsByCity =
  hotelService.fetchHotelsByCity.bind(hotelService);
export const fetchFeaturedHotels =
  hotelService.fetchFeaturedHotels.bind(hotelService);

// Hotel sync methods
export const getHotelByIdOrSlug =
  hotelService.getHotelByIdOrSlug.bind(hotelService);
...
export const getStaticHotelData =
  hotelService.getStaticHotelData.bind(hotelService);
export const getStaticBookingsData =
  hotelService.getStaticBookingsData.bind(hotelService);
export const getStaticAmenitiesData =
  hotelService.getStaticAmenitiesData.bind(hotelService);
export const getOwnerHotels = hotelService.getOwnerHotels.bind(hotelService);

// Wedding legacy exports
export const getWeddingVendors =
  weddingService.getWeddingVendors.bind(weddingService);
export const getStaticWeddingVendors =
  weddingService.getStaticWeddingVendors.bind(weddingService);
export const getStaticWeddingBookings =
  weddingService.getStaticWeddingBookings.bind(weddingService);
export const getVendorById = weddingService.getVendorById.bind(weddingService);
export const getVendorByIdAsync =
  weddingService.getVendorByIdAsync.bind(weddingService);
export const getVendorsByLocation =
  weddingService.getVendorsByLocation.bind(weddingService);
export const getVendorsByLocationAsync =
  weddingService.getVendorsByLocationAsync.bind(weddingService);
export const getFeaturedVendors =
  weddingService.getFeaturedVendors.bind(weddingService);
export const getFeaturedVendorsAsync =
  weddingService.getFeaturedVendorsAsync.bind(weddingService);
export const searchVendors = weddingService.searchVendors.bind(weddingService);
export const searchVendorsAsync =
  weddingService.searchVendorsAsync.bind(weddingService);
export const getWeddingBookings =
  weddingService.getWeddingBookings.bind(weddingService);
export const getBookingsByVendorId =
  weddingService.getBookingsByVendorId.bind(weddingService);
export const getBookingsByUserId =
  weddingService.getBookingsByUserId.bind(weddingService);
...
export const updateVendorSections =
  weddingService.updateVendorSections.bind(weddingService);
export const getVendorStats =
  weddingService.getVendorStats.bind(weddingService);
export const createWeddingWebsite =
  weddingService.createWeddingWebsite.bind(weddingService);

// Wedding additional exports
export const getVendorsObject =
  weddingService.getVendorsObject.bind(weddingService);
export const getSections = weddingService.getSections.bind(weddingService);
export const getWebsiteTemplates =
  weddingService.getWebsiteTemplates.bind(weddingService);
export const getDefaultSectionOrder =
  weddingService.getDefaultSectionOrder.bind(weddingService);
export const getDefaultSectionVisibility =
  weddingService.getDefaultSectionVisibility.bind(weddingService);
