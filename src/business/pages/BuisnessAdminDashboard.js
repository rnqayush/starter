        ...
        return (
          <ContentSection>
            ...
            <div style={{ marginBottom: theme.spacing.xl }}>
              <h3 style={{ marginBottom: theme.spacing.lg, color: theme.colors.gray800 }}>Section Titles & Subtitles</h3>
              <FormGrid>
                <FormGroup>
                  <FormLabel>Services Section Title</FormLabel>
                  <FormInput
                    value={uiContentData.sections?.services?.title || ''}
                    onChange={e => {
                      setUiContentData(prev => ({
                      ...
                      trackSectionChange('ui-content');
                    }}
                    placeholder="Our Services"
                  />
                </FormGroup>
                <FormGroup>
                  <FormLabel>Services Section Subtitle</FormLabel>
                  <FormTextarea
                    value={uiContentData.sections?.services?.subtitle || ''}
                    onChange={e => {
                      setUiContentData(prev => ({
                ...
                <FormGroup>
                  <FormLabel>Testimonials Section Subtitle</FormLabel>
                  <FormTextarea
                    value={uiContentData.sections?.testimonials?.subtitle || ''}
                    onChange={e => {
                      setUiContentData(prev => ({
            ...
            <div style={{ marginBottom: theme.spacing.xl }}>
              <h3 style={{ marginBottom: theme.spacing.lg, color: theme.colors.gray800 }}>Button Labels</h3>
              <FormGrid>
                <FormGroup>
                  <FormLabel>Primary Action Button</FormLabel>
                  <FormInput
