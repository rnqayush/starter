...
const EcommerceCategoryLanding = () => {
  const mockups = [
    {
      title: "Fashion Store",
      description: "Modern e-commerce design perfect for fashion brands with clean product showcases and smooth checkout.",
    ...
    },
    {
      ...
      description: "Technical product showcase with detailed specifications, comparison tools, and trust signals.",
    ...
    },
    {
      ...
      description: "Artistic design showcasing unique handmade products with storytelling and artisan profiles.",
