  ...
  const mockups = [
    {
      ...
      description: "Elegant design showcasing premium accommodations with stunning visuals and seamless booking experience.",
    ...
    },
    {
      ...
      description: "Intimate and personalized website design perfect for boutique hotels and bed & breakfasts.",
    ...
    },
    {
      ...
      description: "Professional multi-location website with centralized management and location-specific content.",
