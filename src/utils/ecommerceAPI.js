...
export const ecommerceAPI = {
  ...
  async updateVendorInfo(vendorSlug, vendorData) {
    ...
    try {
      ...
      return createApiResponse(vendorData, true, 'Store information updated successfully');
    } catch (error) {
  ...
  async updatePageSections(vendorSlug, sections) {
    ...
    try {
      ...
      return createApiResponse(sections, true, 'Page sections updated successfully');
    } catch (error) {
  ...
  async updateSection(vendorSlug, sectionId, sectionData) {
    ...
    try {
      ...
      return createApiResponse(sectionData, true, 'Section updated successfully');
    } catch (error) {
  ...
  async createProduct(vendorSlug, productData) {
    ...
    try {
      ...
      return createApiResponse(newProduct, true, 'Product created successfully');
    } catch (error) {
  ...
  async updateProduct(vendorSlug, productId, productData) {
    ...
    try {
      ...
      return createApiResponse(updatedProduct, true, 'Product updated successfully');
    } catch (error) {
  ...
  async createCategory(vendorSlug, categoryData) {
    ...
    try {
      ...
      return createApiResponse(newCategory, true, 'Category created successfully');
    } catch (error) {
  ...
  async updateCategory(vendorSlug, categoryId, categoryData) {
    ...
    try {
      ...
      return createApiResponse(categoryData, true, 'Category updated successfully');
    } catch (error) {
  ...
  async updateOrderStatus(vendorSlug, orderId, status) {
    ...
    try {
      ...
      return createApiResponse({ orderId, status }, true, 'Order status updated successfully');
    } catch (error) {
  ...
  async respondToEnquiry(vendorSlug, enquiryId, response) {
    ...
    try {
      ...
      return createApiResponse({ enquiryId, response }, true, 'Response sent successfully');
    } catch (error) {
